...
public class UserDao extends BaseDao<User> {
    private final String GET_USER_BY_USERNAME = "from t_user u where u.userName = ?";
    private final String QUERY_USER_BY_USERNAME = "from t_user u where u.userName like ?";
